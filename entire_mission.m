...
% delta_v(2) capture on Vesta
% delta_v(3) change orbit on Vesta
% delta_v(4) escape from Vesta
% delta_v(5) capture on Ceres
...
[Earth_esc, delta_v(1)] = escape_hyp(3,EM_orbit(1:2,1:3),[2007 9 27 0 0 0],...
...
[~, ~, delta_change(2)] = change_of_plane(orb_elem1(4), orb_elem21(4), orb_elem1(3), orb_elem21(3), norm(sp_todawn)); 
%% Mars SOI close-up
if exist('figure2') == 0
    figure()
else
...
[Vesta_cap, delta_v(2)] = capture_hyp(10,MV_orbit(end-1:end,1:3),[2011 7 16 0 0 0],...
...
[Vesta_esc, delta_v(4)] = escape_hyp(10,VC_orbit(1:2,1:3),[2012 9 5 0 0 0],...
...
[Ceres_cap, delta_v(5)] = capture_hyp(11,VC_orbit(end-1:end,1:3),[2015 3 5 0 0 0],...
