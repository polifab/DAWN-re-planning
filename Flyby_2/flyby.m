function [flyby_parameters] = flyby(id_planet,theta_inf,altitude,alpha_x,beta_y,gamma_z)
...
%             escape velocity vector of spaceship
...
deg = pi/180;
%Angles of hyperbole
    theta = -theta_inf+1:1:theta_inf-1; %Vetor that contains angles between 
...
hold on;
    ...
    plot(xunit, yunit);
    title("Flyby trajectory close " + planet(3));
    fprintf('\n   Radius of influence of ' + planet(3) + '   = ' + planet(2) + ' (km) %g\n') 
    fprintf('\n   Radius of ' + planet(3) + '                = ' + planet(1) + ' (km) %g\n')
