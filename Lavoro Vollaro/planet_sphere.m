function [xx,yy,zz] = planet_sphere(varargin)%NOT COMPLETED
...
%   Made with modifications to the original file by:
...
%     colormap(topomap1)
    ...
    topography = imread('mars.jpg');
    % Set it on MOON
    set(h,'facecolor','texture',...
              'cdata',im2double(topography),...
              'edgecolor','none');
