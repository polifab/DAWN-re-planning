...
% CHANGE_OF_PLANE computes relevant quantities for a change of plane.
%
%   INPUT:
...
%       W2 - target RAAN (rad)
%       v_initial - velocity of the spacecraft in the initial orbit (km/s)
%
%   OUTPUT:
%       inclination_change  - change of inclination between initial and
%                             target orbit
%       true_anomaly        - position of the spacecraft in orbit
%       DV                  - delta v required for the change of plane
%
