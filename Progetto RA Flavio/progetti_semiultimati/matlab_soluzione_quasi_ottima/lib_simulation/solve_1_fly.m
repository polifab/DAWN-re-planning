    ...
    tet_lancio = 115*pi/180;             %angolo di sgancio dalla soi della terra
    tet_end = 338*pi/180;                   %angolo ingresso soi di venere nel suo sistema di riferimento
    teta_long_terra = 3.35*pi/180;
    teta_long_ven = 14*pi/180;          %day_start = 250 end 329
    vol1.tet_end = tet_end;
    ...
    t1 = temp(day_start);
    t_target = temp(329);             %ho scelto come data di arrivo il 7 Luglio 2019
