...
% GROUND_TRACK plots the ground track of an earth satellite
...
% User M-functions required: sv_from_coe, kepler_E, ra_and_dec_from_r
    ...
    %{
        Propagates the orbit over the specified time interval, 
        transforming the position vector into the earth-fixed frame and, 
        from that, computing the right ascension and declination histories
    %}
