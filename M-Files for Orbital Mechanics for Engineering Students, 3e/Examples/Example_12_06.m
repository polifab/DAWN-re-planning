...
RE      = 695508;                   %sun radius [km]             6378;                    %Earth's radius (km)
J2      = 2.217E-7;%1082.63e-6;      %planet J2        %Earth's J2 

%% Initial conditions 
% Initial orbital parameters (given):
rp0     = 381000e+3;%RE + 300;                %perigee radius (km)
ra0     = 447000e+3; %RE + 3062;               %apogee radius (km
RA0     = 45*deg;                  %Right ascencion of the node (radians)
i0      = 10.6*deg;                  %Inclination (radians)
...
t0      = 0;
tf      = 1690*days;
nout    = 1690*2;  %Number of solution points to output for plotting purposes
